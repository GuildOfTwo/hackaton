    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=12, validators=[django.core.validators.RegexValidator(message='Формат номера телефона: +79999999999', regex='^\\+?7?\\d{10,10}$')], verbose_name='Контактный телефон')),
                ('adress', models.CharField(blank=True, max_length=300, verbose_name='Адрес организации')),
                ('inn', models.IntegerField(blank=True, verbose_name='ИНН организации')),
                ('organization_name', models.CharField(blank=True, max_length=300, verbose_name='Название организации')),
