    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', models.PositiveIntegerField(blank=True, help_text='Введите стоимость аренды за сутки', verbose_name='Стоимость')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stat', models.CharField(choices=[('Опубликовано', 'Опубликовано'), ('Заблокировано', 'Заблокировано'), ('Снято с публикации', 'Снято с публикации')], help_text='Выберите состояние добавленного обьекта', max_length=200, verbose_name='Состояние')),
